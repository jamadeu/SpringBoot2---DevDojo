...
class AnimeControllerIT {
    ...
    void findByName_ReturnsAnEmptyListOfAnimes_WhenAnimeIsNotFound() {
        List<Anime> animes = testRestTemplate.exchange("/animes/find?name=animeNotFound", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
    ...
    void save_ReturnsAnime_WhenSuccessful() {
        ...
        ResponseEntity<Anime> animeResponseEntity = testRestTemplate.postForEntity("/animes", newAnimeRequest, Anime.class);
